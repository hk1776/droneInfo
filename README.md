...
https://github.com/hk1776/droneInfo/assets/77769783/ae06d9a9-50a4-4b75-8123-f2e2d066cb60
  ...
  ## 🎓Conclusion
 소켓 통신으로 드론의 비행 상태 정보를 실시간으로 받아와 웹에 표출하는 과정에서 Three.js, Highcharts 등의 자바스크립트 라이브러리를 사용해봤고 실시간 영상 처리 및 반응형 웹을 제작하면서 프론트엔트 개발 부분에 있어서 많은 부분을 배우고 실습해 볼 수 있는 경험이였다.
